...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        {
            return await _context.Groups.Include(m => m.Connections)
            .Where(m => m.Connections.Any(n => n.ConnectionId == connectionId)).FirstOrDefaultAsync();
        }
        ...
        {
            return await _context.Groups.Include(m => m.Connections).FirstOrDefaultAsync(m => m.Name == groupName);
        }
